...
description: >
  <p>एक <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> ऑब्जेक्ट बनाता है।</p>
  ...
  व्याख्या किए गए इन मापदंडों को <a href="/p5.js-website/reference/p5/colorMode">colorMode()</a> फ़ंक्शन के साथ बदला जा सकता है।</p>
...
overloads:
  - line: 398
    params:
      ...
      - name: alpha
        description: |
          <p>वर्तमान रंग सीमा के सापेक्ष अल्फा मान (डिफ़ॉल्ट मान 0-255 है)।</p>
        type: Number
        optional: true
    return:
