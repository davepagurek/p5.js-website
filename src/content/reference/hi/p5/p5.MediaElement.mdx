...
description: >
  ...
  <p><code>p5.MediaElement</code> extends <a
  href="/p5.js-website/reference/p5/p5.Element">p5.Element</a> with

  methods to handle audio and video. <code>p5.MediaElement</code> objects are
  created by

  calling <a href="/p5.js-website/reference/p5/createVideo">createVideo</a>,

  <a href="/p5.js-website/reference/p5/createAudio">createAudio</a>, and

  <a href="/p5.js-website/reference/p5/createCapture">createCapture</a>.</p>
line: 4080
isConstructor: true
params:
  - name: elt
