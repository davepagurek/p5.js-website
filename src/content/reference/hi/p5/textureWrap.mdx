...
description: >
  ...
  <p><a href="/p5.js-website/reference/p5/texture">texture()</a> को काम करने के लिए, किसी आकृति को उसकी सतह पर बिंदुओं को छवि में पिक्सेल पर मैप करने के तरीके की आवश्यकता होती है। <a href="/p5.js-website/reference/p5/rect">rect()</a> और <a href="/p5.js-website/reference/p5/box">box()</a> जैसी अंतर्निहित आकृतियाँ पहले से ही मौजूद हैं बनावट मानचित्रण
  उनके शीर्षों के आधार पर। <a href="/p5.js-website/reference/p5/vertex">vertex()</a> के साथ बनाई गई कस्टम आकृतियों को यूवी निर्देशांक के रूप में पारित होने के लिए बनावट मैपिंग की आवश्यकता होती है।</p>

  <p>प्रत्येक कॉल <a href="/p5.js-website/reference/p5/vertex">vertex()</a> में 5 तर्क शामिल होने चाहिए, जैसे <code>vertex(x, y, z, u, v)</ कोड>, एक छवि के भीतर निर्देशांक <code>(x, y, z)</code> पर शीर्ष को निर्देशांक <code>(u, v)</code> पर पिक्सेल पर मैप करने के लिए। उदाहरण के लिए, एक आयताकार छवि के कोनों को डिफ़ॉल्ट रूप से एक आयत के कोनों पर मैप किया जाता है:</p>
