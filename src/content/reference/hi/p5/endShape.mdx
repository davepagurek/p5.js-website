...
description: >
  ...
  <p> <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> और <code>endShape()</code> फ़ंक्शन 2D या 3D में कस्टम आकार बनाने की अनुमति देते हैं।

  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> एक कस्टम आकार में शीर्ष जोड़ना शुरू करता है और <code>endShape()</code> उन्हें जोड़ना बंद कर देता है।</p>
  ...
  <p>रूपांतरण जैसे <a href='/p5.js-website/reference/p5/translate'>translate()</a>, <a href='/p5.js-website/reference/p5/rotate'>rotate()</a>, और <a href='/p5.js-website/reference/p5/scale'>scale()</a> <a href='/p5.js-website/reference/p5/beginShape'>beginShape()</a> और <code>endShape()</code> के बीच काम नहीं करता है। 
  
  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> और <code>endShape()</code> के बीच अन्य आकृतियों का उपयोग करना भी संभव नहीं है, जैसे <a href='/p5.js-website/reference/p5/ellipse'>ellipse()</a> या <a href='/p5.js-website/reference/p5/rect'>rect()</a>।</p>
line: 1344
isConstructor: false
itemtype: तरीका
example:
