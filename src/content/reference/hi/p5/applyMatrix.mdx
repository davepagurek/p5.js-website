...
description: >
   ...
   <p>रूपांतरण जैसे <a href='/p5.js-website/reference/p5/translate'>translate()</a>, <a href='/p5.js-website/reference/p5/rotate'>rotate()</a>, और <a href='/p5.js-website/reference/p5/scale'>scale()</a> पर्दे के पीछे मैट्रिक्स-वेक्टर गुणन का उपयोग करें। संख्याओं की एक तालिका, जिसे मैट्रिक्स कहा जाता है, प्रत्येक परिवर्तन को एन्कोड करती है। फिर मैट्रिक्स में मान कैनवास पर प्रत्येक बिंदु को गुणा करते हैं, जिसे एक वेक्टर द्वारा दर्शाया जाता है।</p>
   ...
   <p>डिफ़ॉल्ट रूप से, परिवर्तन एकत्रित होते हैं। <a href='/p5.js-website/reference/p5/push'>push()</a> और <a href='/p5.js-website/reference/p5/pop'>pop()</a> फ़ंक्शंस का उपयोग भीतर परिवर्तनों को अलग करने के लिए किया जा सकता है विशिष्ट ड्राइंग समूह।</p>
