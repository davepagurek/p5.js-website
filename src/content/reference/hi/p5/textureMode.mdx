...
description: >
  ...
  <p><a href="/p5.js-website/reference/p5/texture">texture()</a> को काम करने के लिए, एक आकार को अपनी सतह के बिंदुओं को एक छवि के पिक्सेलों से मैप करने की आवश्यकता होती है। <a href="/p5.js-website/reference/p5/rect">rect()</a> और <a href="/p5.js-website/reference/p5/box">box()</a> जैसे बिल्ट-इन आकारों में इन पाठ्यवस्तु मैपिंग्स को उनके शीर्षों के आधार पर पहले से मौजूद होता है। <a href="/p5.js-website/reference/p5/vertex">vertex()</a> के साथ बनाए गए कस्टम आकारों के लिए, पाठ्यवस्तु मैपिंग्स को uv निर्देशांकों के रूप में पास की जानी चाहिए।</p> <p><a href="/p5.js-website/reference/p5/vertex">vertex()</a> को प्रत्येक कॉल में 5 आर्गुमेंट होने चाहिए, जैसे <code>vertex(x, y, z, u, v)</code>, ताकि <code>(x, y, z)</code> निर्देशांकों पर मौजूद शीर्ष को किसी छवि में <code>(u, v)</code> निर्देशांकों पर मौजूद पिक्सेल से मैप किया जा सके। उदाहरण के लिए, एक आयतकार छवि के कोनों को डिफ़ॉल्ट रूप से एक आयत के कोनों से मैप किया जाता है:</p>
