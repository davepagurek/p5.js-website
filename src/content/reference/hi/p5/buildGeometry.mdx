...
description: >
  <p>सरल 3D आकृतियों से एक कस्टम <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> ऑब्जेक्ट बनाता है।</p>

  <p><code>buildGeometry()</code> सरल आकृतियों से जटिल 3D आकृतियाँ बनाने में मदद करता है, जैसे कि <a href="/p5.js-website/reference/p5/sphere">sphere()</a>।
  ...
  <p>पैरामीटर, <कोड>कॉलबैक</कोड>, नए <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> ऑब्जेक्ट के लिए ड्राइंग निर्देशों वाला एक फ़ंक्शन है।
  
  नया 3D आकार बनाने के लिए इसे एक बार बुलाया जाएगा।</p>

  <p>निर्माण के दूसरे तरीके के लिए <a href="/p5.js-website/reference/p5/beginGeometry">beginGeometry()</a> और <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> देखें।</p>
