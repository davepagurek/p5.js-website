...
description: >
  ...
  <p><code>panorama()</code> 将包含 360˚ 内容的图像，例如地图或 HDRIs，转换为沉浸式的 3D 背景，围绕在绘图周围。探索空间需要通过诸如<a href="/p5.js-website/reference/p5/orbitControl">orbitControl()</a> 或 <a href="/p5.js-website/reference/p5/camera">camera()</a> 等函数来改变相机的视角。</p>
line: 1020
isConstructor: false
itemtype: method
example:
