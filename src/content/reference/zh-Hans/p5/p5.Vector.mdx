...
description: |2-
  ...
  <p>注意：<a href="/p5.js-website/reference/p5/createVector">createVector()</a>是创建此类实例的推荐方法。</p>
line: '11'
isConstructor: 'true'
params:
  - name: x
...
methods:
  ...
  set:
    description: |2-
      ...
      <p><code>set()</code>可以使用单独的数字，例如<code>v.set(1, 2, 3)</code>，一个<a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a>对象，例如<code>v.set(v2)</code>，或者一个数字数组，例如<code>v.set([1, 2, 3])</code>。</p>
  ...
  copy:
    description: |2-
      ...
      <p>返回<a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a>对象的副本。</p>
    path: p5.Vector/copy
  add:
    description: |2-
      ...
      <p><code>add()</code> 可以使用单独的数字，例如 <code>v.add(1, 2, 3)</code>，另一个 <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> 对象，例如 <code>v.add(v2)</code>，或者数字数组，例如 <code>v.add([1, 2, 3])</code>。</p>
      ...
      <p>静态版本的 <code>add()</code>，例如 <code>p5.Vector.add(v2, v1)</code>，返回一个新的 <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> 对象，并不更改原始对象。</p>
    path: p5.Vector/add
  rem:
  ...
  equals:
    description: |-
      ...
      <p>如果 <code>equals()</code> 只带有一个参数，那么这个参数是另一个 <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> 对象。</p>
      ...
      href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> 对象。</p>
