...
description: |2-
  ...
  <p><code>brightness()</code>从一个 <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> 对象、一个颜色组件组成的数组或者一个 CSS 颜色字符串中提取 HSB 亮度值</p>


  <p>默认情况下，<code>brightness()</code> 返回颜色的 HSB 亮度值，数值范围为 0 到 100。如果 <a href="/p5.js-website/reference/colorMode">colorMode()</a> 设置为 HSB，
  它返回给定范围内的亮度值。</p>
line: '253'
isConstructor: 'false'
itemtype: method
