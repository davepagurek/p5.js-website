...
description: |2-
  ...
  <p>调用 <code>noFill()</code> 相当于填充一个完全透明的颜色，如同调用 <code>fill(0, 0)</code>。如果 <code>noStroke()</code> 和 <a href="/p5.js-website/reference/p5/noFill">noFill()</a> 同时被调用，则画布上不会绘制任何内容。</p>
line: '1219'
isConstructor: 'false'
itemtype: method
example:
