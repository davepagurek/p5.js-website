...
description: >
  ...
  <p>当 p5.js 调用<code>keyReleased()</code>时，<a href="/p5.js-website/reference/p5/key">key</a>和<a href="/p5.js-website/reference/p5/keyCode">keyCode</a>变量将会更新为最近一次释放的值：</p>
