...
description: >
  <p>从简单的 3D 形状创建一个自定义的 <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象</p>

  <p><code>buildGeometry()</code> 有助于从简单形状（例如，<a href="/p5.js-website/reference/p5/sphere">sphere()</a>）创建复杂的 3D 形状。它可以帮助提高绘图性能，例如，
  
  如果一个复杂的 3D 形状在绘图运行时不发生变化，则可以使用 <code>buildGeometry()</code> 来创建。
  
  创建一个 <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象，然后绘制它，会比重复绘制各个部分更快。</p>

  <p>参数 <code>callback</code> 是一个包含新 <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象的绘制指令的函数。它将被调用一次以创建新的 3D 形状。</p>

  <p>了解另一种构建 3D 形状的方法，请参阅 <a href="/p5.js-website/reference/p5/beginGeometry">beginGeometry()</a> 和

  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a>。</p>
