...
description: >
  ...
  <p>参数 <code>detail</code> 是在绘制贝塞尔曲线时要使用的分段数。例如，调用 <code>bezierDetail(5)</code> 函数将使用 5 个分段来绘制贝塞尔曲线。<a href="/p5.js-website/reference/p5/bezier">bezier()</a> function. 默认情况下，<code>detail</code> 是 20。</p>
