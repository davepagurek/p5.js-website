...
description: |-
  ...
  <p><code>height</code> 的默认值是 100，调用 <a href="/p5.js-website/reference/p5/createCanvas">createCanvas()</a>  或 <a href="/p5.js-website/reference/p5/resizeCanvas">resizeCanvas()</a> 会改变 <code>height</code> 的值。 调用 <a href="/p5.js-website/reference/p5/noCanvas">noCanvas()</a> 将其值设为 0。</p>
line: '872'
isConstructor: 'false'
itemtype: property
example:
