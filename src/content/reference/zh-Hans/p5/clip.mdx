...
description: >
  ...
  <p>遮罩可以被包含在 <a href="/p5.js-website/reference/p5/push">push()</a> 和 <a href="/p5.js-website/reference/p5/pop">pop()</a> 函数之间。这样可以让未被遮罩的形状在遮罩形状之后被绘制。</p>

  <p>遮罩也可以通过 <a href="/p5.js-website/reference/p5/beginClip">beginClip()</a> 和 <a href="/p5.js-website/reference/p5/endClip">endClip()</a> 来定义。</p>
line: 222
isConstructor: false
itemtype: method
example:
