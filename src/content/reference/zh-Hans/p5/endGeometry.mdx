...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象添加形状，并返回该对象。</p>

  <p><code>beginGeometry()</code> 和 <a
  href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 函数有助于从简单形状（例如 <a href="/p5.js-website/reference/p5/sphere">sphere()</a>）创建复杂的 3D 形状。
  
  <code>beginGeometry()</code> 开始向自定义的 <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象添加形状，而

  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 则停止添加。</p>

  <p><code>beginGeometry()</code> 和 <a
  href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 有助于提高绘图性能。例如，如果一个复杂的 3D 形状在绘图运行时不发生变化，
  
  则可以使用 <code>beginGeometry()</code> 和 <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 来创建。

  创建一次 <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象，然后绘制它，会比重复绘制各个部分更快。</p>

  <p>了解另一种构建 3D 形状的方法，请参阅 <a href="/p5.js-website/reference/p5/buildGeometry">buildGeometry()</a>。</p>
