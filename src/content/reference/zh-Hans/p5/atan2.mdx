...
description: >
  ...
  <p>默认情况下，<code>atan2()</code> 返回的值范围是 -π（约-3.14）到 π（3.14）。如果 <a href="/p5.js-website/reference/p5/angleMode">angleMode()</a> 设置为 <code>DEGREES</code>，则返回的值范围是 -180 到 180。</p>
line: 204
isConstructor: false
itemtype: method
example:
