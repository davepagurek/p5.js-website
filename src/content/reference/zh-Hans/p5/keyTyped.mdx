...
description: >
  ...
  <p>当 <code>keyTyped()</code> 由 p5.js 调用时，变量 <a href="/p5.js-website/reference/p5/key">key</a> 和 <a href="/p5.js-website/reference/p5/keyCode">keyCode</a> 将更新为最近释放的值：</p>
  ...
  <p>注意：使用 <a href="/p5.js-website/reference/p5/keyPressed">keyPressed()</a> 函数和 <a href="/p5.js-website/reference/p5/keyCode">keyCode</a> 系统变量来响应 <code>ALT</code> 等修饰键。</p>
