...
description: >
  ...
  <p>矩形是由 <code>x</code>、<code>y</code>、<code>w</code> 和 <code>h</code> 参数定义的四边形。 <code>x</code> 和 <code>y</code> 设置其左上角的位置。 <code>w</code> 设置其宽度，<code>h</code> 设置其高度。矩形中的每个角都是 90˚。请参阅 <a href="/p5.js-website/reference/p5/rectMode">rectMode()</a> 了解其他定义矩形的方式。</p>
