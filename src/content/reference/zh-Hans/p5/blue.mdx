...
description: |2-
  ...
  <p><code>blue()</code> 从一个 <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> 对象、一个由颜色组件组成的数组或一个 CSS 颜色字符串中提取蓝色色值。</p>


  <p>默认情况下，<code>blue()</code> 返回 0 到 255 范围内的蓝色值。如果 <a href="/p5.js-website/reference/colorMode">colorMode()</a> 设置为 RGB，
  它返回给定范围内的蓝色值。</p>
line: '117'
isConstructor: 'false'
itemtype: method
