...
description: >
  ...
  <p><code>lightness()</code> 从 <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> 对象、颜色组件的数组或 CSS 颜色字符串中提取 HSL 亮度值。</p>

  <p>默认情况下，<code>lightness()</code> 以 0 到 100 的范围返回颜色的 HSL 亮度值。如果 <a href="/p5.js-website/reference/colorMode">colorMode()</a> 被设置为 HSL，它将返回给定范围内的亮度值。</p>
line: 1071
isConstructor: false
itemtype: method
example:
