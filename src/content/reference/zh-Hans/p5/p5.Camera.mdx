...
description: >
  ...
  controlled with the <a href="/p5.js-website/reference/p5/camera">camera()</a>,

  <a href="/p5.js-website/reference/p5/perspective">perspective()</a>,

  <a href="/p5.js-website/reference/p5/ortho">ortho()</a>, and

  <a href="/p5.js-website/reference/p5/frustum">frustum()</a> functions. Additional cameras
  can be

  created with <a href="/p5.js-website/reference/p5/createCamera">createCamera()</a> and
  activated

  with <a href="/p5.js-website/reference/p5/setCamera">setCamera()</a>.</p>
