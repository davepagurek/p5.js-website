...
description: |2-
  ...
  <p>现有图像可以通过调用 <a href="/p5.js-website/reference/p5/loadImage">loadImage()</a> 加载。空白图像可以通过
  调用 <a href="/p5.js-website/reference/p5/createImage">createImage()</a>创建。
...
methods:
  ...
  updatePixels:
    description: |2-
      ...
      <p>使用 <a href="/p5.js-website/reference/p5.Image/pixels">img.pixels</a> 数组中的 RGBA 值更新画布。</p>


      <p>在更改 <a href="/p5.js-website/reference/p5.Image/pixels">img.pixels</a> 数组后，才需要调用<code>img.updatePixels()</code>。

      在调用 <a href="/p5.js-website/reference/p5.Image/loadPixels">img.loadPixels()</a> 或调用 <a href="/p5.js-website/reference/p5.Image/set">img.set()</a> 后，可以直接更改。</p>
  ...
  get:
    description: |2-
      ...
      <a href="/p5.js-website/reference/p5.Image/pixels">img.pixels</a>。使用


      <a href="/p5.js-website/reference/p5.Image/pixels">img.pixels</a> 读取多个像素
      值。</p>
      ...
      该分段的宽度和高度。它返回了新 <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> 对象中画布的一个分段。</p>

      <p>使用<code>img.get()</code>代替<a
      href="/p5.js-website/reference/p5/get">get()</a> 来直接处理图像。</p>
    path: p5.Image/get
  set:
    description: |2-
      ...
      <a href="/p5.js-website/reference/p5.Image/pixels">img.pixels</a> 设置多个像素
      值。</p>
      ...
      数组、一个 <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> 对象或
      <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> 对象。</p>


      <p>使用<code>img.set()</code> 显示更改后，必须要调用<a href="/p5.js-website/reference/p5.Image/updatePixels">img.updatePixels()</a>。</p>
    path: p5.Image/set
  resize:
    description: |2-
  ...
  copy:
    description: |2-
      ...
      <p>第一个参数<code>srcImage</code>是可选的要复制的 <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> 对象。如果源
  ...
  mask:
    description: |2-
      ...
      href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> 对象的
  ...
  blend:
    description: |2-
      ...
      <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> 对象进行混合。</p>
  ...
  save:
    description: |2-
      ...
      。请参阅 <a href="/p5.js-website/reference/p5/saveGif">saveGif()</a> 来
      创建新的 GIF。</p>
    path: p5.Image/save
  reset:
    description: |2-
  ...
  play:
    description: |2-
      ...
      <p>播放因为 <a href="/p5.js-website/reference/p5.Image/pause">img.pause()</a> 暂停的 GIF 动画。</p>
    path: p5.Image/play
  pause:
    description: |2-
      ...
      <p>GIF 可以通过调用 <a href="/p5.js-website/reference/p5.Image/play">img.play()</a> 来恢复。</p>
    path: p5.Image/pause
  delay:
    description: |2-
