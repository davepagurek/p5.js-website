...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 对象。</p>

  <p><code>loadModel()</code> 可以从 OBJ 和 STL 文件加载 3D 模型。一旦加载了模型，就可以使用

  <a href="/p5.js-website/reference/p5/model">model()</a> 函数来显示，如
  ...
  <p>模型加载可能需要一些时间。在 <a href="/p5.js-website/reference/p5/preload">preload()</a> 中调用 <code>loadModel()</code> 
  可以确保模型在被用于 <a href="/p5.js-website/reference/p5/setup">setup()</a> 或 <a
  href="/p5.js-website/reference/p5/draw">draw()</a> 之前加载完成。</p>
