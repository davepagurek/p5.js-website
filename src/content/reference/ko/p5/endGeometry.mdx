...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체를 
  반환합니다.</p>

  <p><code>beginGeometry()</code> 와 <a
  href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 함수는 

  <a href="/p5.js-website/reference/p5/sphere">sphere()</a>와 같은 간단한 모양으로부터 
  ...
  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 는 추가를 멈춥니다.</p>

  <p><code>beginGeometry()</code> 와 <a
  href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 는 스케치를 더욱 효율적으로 만드는 데 도움이 될 수 있습니다. 
  ...
  href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 로 생성될 수 있습니다.

  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체를 한 번 생성하고
  그리는 것은

  그 조각들을 반복적으로 하나씩 그리는 것보다 실행 속도가 빠릅니다.</p>

  <p><a href="/p5.js-website/reference/p5/buildGeometry">buildGeometry()</a> 를
  통해
