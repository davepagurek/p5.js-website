...
description: >
  ...
  <p><a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> 와
  <code>endShape()</code> 함수는

  2D 또는 3D에서 사용자 정의 도형을 만드는 것을 가능하게 합니다. 

  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> 는 사용자 정의 도형에 
  꼭짓점을 추가하기 시작하며 
  ...
  <p><a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> 를 
  호출한 후에는,
  ...
  <a href="/p5.js-website/reference/p5/quadraticVertex">quadraticVertex()</a>,

  <a href="/p5.js-website/reference/p5/curveVertex">curveVertex()</a> 등을 호출하여 도형을 만들 수 있습니다. 
  ...
  <p>변형기능인 <a href="/p5.js-website/reference/p5/translate">translate()</a>,

  <a href="/p5.js-website/reference/p5/rotate">rotate()</a>,

  <a href="/p5.js-website/reference/p5/scale">scale()</a> 은

  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> 와
  <code>endShape()</code> 사이에서는 작동하지 않습니다. 

  또한 <a
  href="/p5.js-website/reference/p5/ellipse">ellipse()</a> 와

  <a href="/p5.js-website/reference/p5/rect">rect()</a>와 같은 도형은 
