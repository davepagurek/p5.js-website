...
description: >
  ...
  <p><code>saturation()</code> 는

  <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> 
  객체, 색상 요소 배열, 또는 CSS 색상 문자열로부터 
  ...
  <a href="/p5.js-website/reference/colorMode">colorMode()</a> 가 HSB 또는 HSL로 설정되어 있다면,
