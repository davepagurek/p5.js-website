...
description: >
  ...
  <p><a href="/p5.js-website/reference/p5/translate">translate()</a>, <a href="/p5.js-website/reference/p5/rotate">rotate()</a>,

  <a href="/p5.js-website/reference/p5/scale">scale()</a>와 같은 변환은 행렬-벡터 곱셈을 내부적으로 사용합니다.
  ...
  <a href="/p5.js-website/reference/p5/draw">draw()</a> 함수 내에서 <code>applyMatrix()</code>를 호출해도 도형이 계속해서 변환되지 않습니다.</p>
line: 11
isConstructor: false
itemtype: method
example:
