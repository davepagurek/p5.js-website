...
description: >
  <p>더 간단한 3D 도형으로부터 사용자 지정 <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 
  객체를

  만듭니다.</p>

  <p><code>buildGeometry()</code> 는 <a href="/p5.js-website/reference/p5/sphere">sphere()</a>
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체를 한 번 생성후 
  그리는 것은 
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체에 대한 그리기 지침을 가진 함수입니다. 
  3D 도형을 만들기 위해,

  한 번 호출됩니다.</p>

  <p><a href="/p5.js-website/reference/p5/beginGeometry">beginGeometry()</a> 와

  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> 를 통해
  3D 도형을 만드는
