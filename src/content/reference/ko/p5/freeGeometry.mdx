...
description: >
  <p><a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체를 
  그래픽 처리 장치(GPU) 

  메모리에서 제거합니다.</p>

  <p><a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체에는
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체의 자원을
   GPU 메모리에서 해제함으로써 성능을 향상시킬 수 있습니다.

  <code>freeGeometry()</code> 는 <a
  href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체로 작동하는데,

  p5.Geometry는 <a href="/p5.js-website/reference/p5/beginGeometry">beginGeometry()</a> 와

  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a>,

  <a href="/p5.js-website/reference/p5/buildGeometry">buildGeometry()</a>, 그리고

  <a href="/p5.js-website/reference/p5/loadModel">loadModel()</a> 로 생성됩니다.</p>
  ...
  <p>참고: <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> 객체는 
