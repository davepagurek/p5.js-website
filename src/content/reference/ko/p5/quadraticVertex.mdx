...
description: >
  ...
  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> 및

  <a href="/p5.js-website/reference/p5/endShape">endShape()</a> 함수 사이에서 호출되어야 합니다. 
  곡선은

  이전 꼭짓점을 첫 번째 앵커 포인트(anchor point)로 사용하므로,

  <code>quadraticVertex()</code> 함수를 사용하기 전에, 
  최소한 한 번 <a href="/p5.js-website/reference/p5/vertex">vertex()</a> 를 
  ...
  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> 에
