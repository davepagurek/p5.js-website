...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> 객체, 색상 구성 요소의 배열,
  또는 CSS 색상 문자열에서
  ...
  100까지의 범위로 반환합니다. 만약 <a href="/p5.js-website/reference/colorMode">colorMode()</a> 가 HSL로 설정되어 있다면,
  주어진 범위 내의
