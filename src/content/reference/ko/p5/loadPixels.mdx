...
description: |
  <p>캔버스의 각 픽셀의 현재 값을 <a href="/p5.js-website/reference/p5/pixels">pixels</a> 배열에 불러옵니다.</p>
  <p><code>loadPixels()</code>은 <a href="/p5.js-website/reference/p5/pixels">pixels</a>를 읽거나 쓰기 전에 호출해야 합니다.</p>
line: 946
isConstructor: false
itemtype: method
example:
