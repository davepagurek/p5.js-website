...
description: |2-
  ...
  <a
  href="/p5.js-website/reference/p5/createCanvas">createCanvas()</a>에 의해 생성된 캔버스 요소와 <a href="/p5.js-website/reference/p5/createGraphics">createGraphics()</a>에 의해 생성된 <a href="/p5.js-website/reference/p5/p5.Renderer">p5.Render</a> 객체는 예외입니다.</p>
line: '255'
isConstructor: 'false'
itemtype: method
example:
