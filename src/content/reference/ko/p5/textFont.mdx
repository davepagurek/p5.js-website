...
description: >
  <p><a href="/p5.js-website/reference/p5/text">text()</a> 함수에서 사용할 글꼴을 설정합니다.</p>
  
  <p>첫 번째 매개변수 <code>font</code>는 글꼴을 설정합니다.
  
  <code>textFont()</code>는 <a href="/p5.js-website/reference/p5/p5.Font">p5.Font</a> 객체나
  
  시스템 글꼴의 이름을 가진 문자열을 인식합니다.
  ...
  이는 <a href="/p5.js-website/reference/p5/textSize">textSize()</a>를 호출하는 것과 동일한 효과입니다.</p>
  
  <p>참고: <code>WEBGL</code> 모드는
  
  <a href="/p5.js-website/reference/p5/loadFont">loadFont()</a>로 불러온 글꼴만 지원합니다.</p>
line: 335
isConstructor: false
itemtype: method
example:
...
overloads:
  ...
  - line: 418
    params:
      - name: font
        description: |
          <p><a href="#/p5.Font">p5.Font</a> 객체 또는 문자열 형식의 글꼴.</p>
        type: Object|String
      - name: size
        description: |
          <p>픽셀 단위의 글꼴 크기.</p>
