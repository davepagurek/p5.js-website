...
description: >
  <p><a href="/p5.js-website/reference/p5/specularMaterial">specularMaterial()</a>의 금속성 양을 설정합니다.</p>
  <p><code>metalness()</code>는 재질을 더 금속처럼 보이게 할 수 있습니다. <a href="/p5.js-website/reference/p5/directionalLight">directionalLight()</a>, <a href="/p5.js-website/reference/p5/pointLight">pointLight()</a>, <a href="/p5.js-website/reference/p5/spotLight">spotLight()</a>, 그리고 <a href="/p5.js-website/reference/p5/imageLight">imageLight()</a>를 포함한 광원을 반사하는 방식에 영향을 줍니다.</p>
