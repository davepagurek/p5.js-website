...
description: >
  <p>WebGL 모드에서 베지어 곡선을 그릴 때 사용되는 선분 수를 설정합니다.</p>

  <p>WebGL 모드에서는 부드러운 모양을 많은 평면 선분을 사용하여 그립니다. 

  더 많은 평면의 선분을 추가하면 모양이 더 부드럽게 보입니다.</p>

  <p>매개변수 <code>detail</code>은 
  베지어 곡선을 그릴 때 사용할 선분 수입니다. 

  예를 들어, <code>bezierDetail(5)</code>
  을 호출하면 

  <a href="/p5.js-website/reference/p5/bezier">bezier()</a> 함수를 사용하여 곡선을 그릴 때 5개의 선분을 사용합니다. 
