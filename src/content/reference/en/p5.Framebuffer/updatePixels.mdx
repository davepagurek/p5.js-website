...
description: >
  ...
  in the <a href="/p5.js-website/reference/p5.Framebuffer/pixels">myBuffer.pixels</a> array.
  Such

  changes can be made directly after calling

  <a href="/p5.js-website/reference/p5.Framebuffer/loadPixels">myBuffer.loadPixels()</a>.</p>
line: 1581
isConstructor: false
itemtype: method
example:
