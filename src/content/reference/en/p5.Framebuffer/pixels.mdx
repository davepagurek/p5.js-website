...
description: >
  ...
  <p><a href="/p5.js-website/reference/p5.Framebuffer/loadPixels">myBuffer.loadPixels()</a>
  must be

  called before accessing the <code>myBuffer.pixels</code> array.

  <a href="/p5.js-website/reference/p5.Framebuffer/updatePixels">myBuffer.updatePixels()</a>
  ...
  <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object instead of looping over
