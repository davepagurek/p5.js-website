...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a>. A shader can only be used
  in the
  ...
  <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a> object to the main canvas
  using

  the <code>window</code> variable, as in
  <code>myShader.copyToContext(window)</code>.</p>

  <p>Note: A <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object created with
