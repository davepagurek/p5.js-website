...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a> objects and generally run
  much

  faster when used as textures. Creating a

  <a href="/p5.js-website/reference/p5/p5.Framebuffer">p5.Framebuffer</a> object in the same
  context
  ...
  href="/p5.js-website/reference/p5/p5.Framebuffer">p5.Framebuffer</a> object. Default is to
