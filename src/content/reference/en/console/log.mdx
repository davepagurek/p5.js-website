...
description: >
  ...
  <a href="/p5.js-website/reference/p5/print">print</a>

  and <a href="/p5.js-website/reference/p5/console/log">console.log</a> interchangeably.</p>
  ...
  be a single <a href="/p5.js-website/reference/p5/string">string</a> (with optional
  substitution values),

  or it may be any one or more JavaScript <a
  href="/p5.js-website/reference/p5/object">objects</a>.</p>
line: 512
isConstructor: false
itemtype: method
