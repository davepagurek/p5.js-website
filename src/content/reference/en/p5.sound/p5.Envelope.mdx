...
description: >-
  ...
  <p>Use <code><a href="/p5.js-website/reference/p5.Envelope/setRange">setRange</a></code> to
  change the attack/release level.

  Use <code><a href="/p5.js-website/reference/p5.Envelope/setADSR">setADSR</a></code> to
  change attackTime, decayTime, sustainPercent and releaseTime.</p>

  <p>Use the <code><a href="/p5.js-website/reference/p5.Envelope/play">play</a></code> method
  to play the entire envelope,

  the <code><a href="/p5.js-website/reference/p5.Envelope/ramp">ramp</a></code> method for a
  pingable trigger,

  or <code><a
  href="/p5.js-website/reference/p5.Envelope/triggerAttack">triggerAttack</a></code>/

  <code><a
  href="/p5.js-website/reference/p5.Envelope/triggerRelease">triggerRelease</a></code> to
...
methods:
  ...
  ramp:
    description: >
      ...
      values from <code><a
      href="/p5.js-website/reference/p5.Envelope/setADSR">setADSR(attackTime,
      decayTime)</a></code>
