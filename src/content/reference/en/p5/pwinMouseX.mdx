...
description: >
  ...
  <a href="/p5.js-website/reference/p5/winMouseX">winMouseX</a> from the previous frame. For
  ...
  <a href="/p5.js-website/reference/p5/winMouseX">winMouseX</a> value at the start of each
  touch

  event.</p>

  <p>Note: Use <a href="/p5.js-website/reference/p5/pmouseX">pmouseX</a> to track the mouse’s
  previous
