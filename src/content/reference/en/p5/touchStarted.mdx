...
description: >
  ...
  <p>The <a href="/p5.js-website/reference/p5/touches">touches</a> array will be updated with
  the most
  ...
  href="/p5.js-website/reference/p5/mousePressed">mousePressed()</a> will
  ...
  touch starts and <a href="/p5.js-website/reference/p5/mousePressed">mousePressed()</a>
  won’t.</p>

  <p>Note: <code>touchStarted()</code>, <a
  href="/p5.js-website/reference/p5/touchEnded">touchEnded()</a>, and

  <a href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> are all related.

  <code>touchStarted()</code> runs as soon as the user touches a touchscreen
  device.

  <a href="/p5.js-website/reference/p5/touchEnded">touchEnded()</a> runs as soon as the user
  ends a

  touch. <a href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> runs repeatedly as
  the
