...
description: >
  ...
  <a href="/p5.js-website/reference/p5/noSmooth">noSmooth()</a> is helpful for scaling up
  images

  without blurring. The functions don't affect shapes or fonts.</p>

  <p>In WebGL mode, <a href="/p5.js-website/reference/p5/noSmooth">noSmooth()</a> causes all
  shapes to
