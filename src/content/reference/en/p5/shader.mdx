...
description: >
  <p>Sets the <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object to apply
  while drawing.</p>
  ...
  <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> objects can be created using
  the

  <a href="/p5.js-website/reference/p5/createShader">createShader()</a> and

  <a href="/p5.js-website/reference/p5/loadShader">loadShader()</a> functions.</p>

  <p>The parameter, <code>s</code>, is the <a
  href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object to
  ...
  <p>The source code from a <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a>
  object's
  ...
  <p>Calling <a href="/p5.js-website/reference/p5/resetShader">resetShader()</a> restores a
  sketch’s
