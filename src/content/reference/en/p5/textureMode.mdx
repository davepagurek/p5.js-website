...
description: >
  ...
  <p>In order for <a href="/p5.js-website/reference/p5/texture">texture()</a> to work, a shape
  needs a

  way to map the points on its surface to the pixels in an image. Built-in

  shapes such as <a href="/p5.js-website/reference/p5/rect">rect()</a> and

  <a href="/p5.js-website/reference/p5/box">box()</a> already have these texture mappings
  based on

  their vertices. Custom shapes created with

  <a href="/p5.js-website/reference/p5/vertex">vertex()</a> require texture mappings to be
  passed as

  uv coordinates.</p>

  <p>Each call to <a href="/p5.js-website/reference/p5/vertex">vertex()</a> must include 5
  arguments,
