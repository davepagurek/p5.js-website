...
description: >
  ...
  <a href="/p5.js-website/reference/p5/fill">fill()</a> and the specular reflections will be

  affected by <a href="/p5.js-website/reference/p5/specularMaterial">specularMaterial()</a>
  and

  <a href="/p5.js-website/reference/p5/shininess">shininess()</a>.</p>

  <p>The parameter, <code>img</code>, is the <a
  href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> object to
