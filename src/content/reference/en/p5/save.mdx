...
description: >
  ...
  The element can be one of <a href="/p5.js-website/reference/p5/p5.Element">p5.Element</a>,an
  Array of

  Strings, an Array of JSON, a JSON object, a <a
  href="/p5.js-website/reference/p5/p5.Table">p5.Table

  </a>, a <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a>, or a p5.SoundFile
  (requires
