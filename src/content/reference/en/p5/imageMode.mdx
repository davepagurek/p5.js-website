...
description: >
  ...
  <a href="/p5.js-website/reference/p5/image">image()</a> is called.</p>

  <p>By default, the first

  two parameters of <a href="/p5.js-website/reference/p5/image">image()</a> are the x- and
  ...
  <a href="/p5.js-website/reference/p5/image">image()</a> as the x- and y-coordinates of the
  image's
