...
description: >
  ...
  <a href="/p5.js-website/reference/p5/gridOutput">gridOutput()</a>, which uses its table as a
  grid.</p>
  ...
  <a href="/p5.js-website/learn/accessible-labels.html">Writing accessible canvas
  descriptions</a>
