...
description: >
  <p>The <a href="/p5.js-website/reference/p5/setShakeThreshold">setShakeThreshold()</a>
  function is used to set the movement threshold for

  the <a href="/p5.js-website/reference/p5/deviceShaken">deviceShaken()</a> function. The
