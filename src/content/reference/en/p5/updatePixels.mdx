...
description: >
  ...
  <a href="/p5.js-website/reference/p5/pixels">pixels</a> array.</p>

  <p><code>updatePixels()</code> only needs to be called after changing values
  in the

  <a href="/p5.js-website/reference/p5/pixels">pixels</a> array. Such changes can be made
  directly

  after calling <a href="/p5.js-website/reference/p5/loadPixels">loadPixels()</a> or by
  calling
