...
description: >
  <p>Returns a value in the web browser's local storage.</p>
  ...
  <p><a href="/p5.js-website/reference/p5/storeItem">storeItem()</a> makes it easy to store
  values in

  <code>localStorage</code> and <code>getItem()</code> makes it easy to retrieve
  them.</p>
  ...
  <p>The second parameter, <code>value</code>, is the value to be retrieved a
  string. For

  example, calling <code>getItem('size')</code> retrieves the value with the key
  <code>size</code>.</p>
