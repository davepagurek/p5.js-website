...
description: >
  ...
  <a href="/p5.js-website/reference/p5/stroke">stroke()</a> function. To change its width, use
  the

  <a href="/p5.js-website/reference/p5/strokeWeight">strokeWeight()</a> function. A point

  can't be filled, so the <a href="/p5.js-website/reference/p5/fill">fill()</a> function won't
  ...
  <a href="/p5.js-website/reference/p5/createCanvas">createCanvas()</a>.</p>

  <p>The version of <code>point()</code> with one parameter allows the point's
  location to

  be set with a <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object.</p>
line: 730
isConstructor: false
itemtype: method
example:
