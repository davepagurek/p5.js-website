...
description: >
  ...
  <a href="/p5.js-website/reference/p5/curve">curve()</a> function. <code>curveVertex()</code>
  must be called

  between the <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> and

  <a href="/p5.js-website/reference/p5/endShape">endShape()</a> functions.</p>
  ...
  <a href="/p5.js-website/reference/p5/endShape">endShape()</a> in order to draw a curve:</p>
  ...
  similar to the <a href="/p5.js-website/reference/p5/curve">curve()</a> function. The
  segments
  ...
  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a>.</p>
line: 832
isConstructor: false
itemtype: method
example:
