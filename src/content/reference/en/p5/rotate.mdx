...
description: >
  ...
  in WebGL mode. If a <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> is passed,
  as in
  ...
  <code>rotate(1)</code> inside the <a href="/p5.js-website/reference/p5/draw">draw()</a>
