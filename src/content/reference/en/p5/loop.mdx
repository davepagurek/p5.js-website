...
description: >
  <p>Resumes the draw loop after <a href="/p5.js-website/reference/p5/noLoop">noLoop()</a> has
  been
  ...
  second. Calling <a href="/p5.js-website/reference/p5/noLoop">noLoop()</a> stops

  <a href="/p5.js-website/reference/p5/draw">draw()</a> from repeating. The draw loop can be
