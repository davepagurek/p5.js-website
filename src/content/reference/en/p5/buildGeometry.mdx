...
description: >
  <p>Creates a custom <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> object
  from
  ...
  such as <a href="/p5.js-website/reference/p5/sphere">sphere()</a>. It can help to make
  sketches
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> object once and then
  drawing it
  ...
  the new <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> object. It will be
  called

  once to create the new 3D shape.</p>

  <p>See <a href="/p5.js-website/reference/p5/beginGeometry">beginGeometry()</a> and

  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> for another way to build
  3D
