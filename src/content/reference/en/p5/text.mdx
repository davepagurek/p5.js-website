...
description: >
  ...
  corner. See <a href="/p5.js-website/reference/p5/textAlign">textAlign()</a> for other ways
  to
  ...
  <a href="/p5.js-website/reference/p5/rectMode">rectMode()</a> for other ways to define the
  ...
  href="/p5.js-website/reference/p5/fill">fill()</a>

  function to set the text's fill color. Call

  <a href="/p5.js-website/reference/p5/stroke">stroke()</a> and

  <a href="/p5.js-website/reference/p5/strokeWeight">strokeWeight()</a> to set the text's
  outline.

  Call <a href="/p5.js-website/reference/p5/textSize">textSize()</a> and

  <a href="/p5.js-website/reference/p5/textFont">textFont()</a> to set the text's size and
  font,
  ...
  <a href="/p5.js-website/reference/p5/loadFont">loadFont()</a>. Calling

  <a href="/p5.js-website/reference/p5/stroke">stroke()</a> has no effect in
