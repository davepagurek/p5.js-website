...
description: >
  ...
  begins if <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a> isn’t
  declared. If

  <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a> is declared, then

  <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a> will run when a user’s
  touch
  ...
  and <a href="/p5.js-website/reference/p5/mouseClicked">mouseClicked()</a> are all related.

  <code>mousePressed()</code> runs as soon as the user clicks the mouse.

  <a href="/p5.js-website/reference/p5/mouseReleased">mouseReleased()</a> runs as soon as the
  user
