...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object.</p>
  ...
  <p>Once the <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object is created,
  it can be

  used with the <a href="/p5.js-website/reference/p5/shader">shader()</a> function, as in
  ...
  required shaders and returns a <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a>
  object.</p>
  ...
  can use the new <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object as its
  ...
  <a href="/p5.js-website/reference/p5/preload">preload()</a> ensures shaders load before
  they're

  used in <a href="/p5.js-website/reference/p5/setup">setup()</a> or <a
  href="/p5.js-website/reference/p5/draw">draw()</a>.</p>
