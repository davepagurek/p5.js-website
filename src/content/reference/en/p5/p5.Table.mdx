...
description: >
  <p><a href="/p5.js-website/reference/p5/p5.Table">Table</a> objects store data with multiple
...
methods:
  addRow:
    description: >
      <p>Use <a href="/p5.js-website/reference/p5/addRow">addRow()</a> to add a new row of
      data to a <a href="/p5.js-website/reference/p5/p5.Table">p5.Table</a> object. By
      default,
      ...
      href="/p5.js-website/reference/p5/set">set()</a>.</p>

      <p>If a <a href="/p5.js-website/reference/p5/p5.TableRow">p5.TableRow</a> object is
  ...
  getRow:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.TableRow">p5.TableRow</a>. The reference
  ...
  getRows:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.TableRow">p5.TableRow</a>s.</p>
  ...
  addColumn:
    description: >
      <p>Use <a href="/p5.js-website/reference/p5/addColumn">addColumn()</a> to add a new
      column to a <a href="/p5.js-website/reference/p5/p5.Table">Table</a> object.
  ...
  removeColumn:
    description: >
      <p>Use <a href="/p5.js-website/reference/p5/removeColumn">removeColumn()</a> to remove
...
properties:
  ...
  rows:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.Table">p5.TableRow</a> objects that make up the

      rows of the table. The same result as calling <a
      href="/p5.js-website/reference/p5/getRows">getRows()</a></p>
    path: p5.Table/rows
chainable: false
---
