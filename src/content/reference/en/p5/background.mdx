...
description: >
  ...
  within <a href="/p5.js-website/reference/p5/draw">draw()</a> to clear the display window at
  the

  beginning of each frame. It can also be used inside

  <a href="/p5.js-website/reference/p5/setup">setup()</a> to set the background on the first
  frame
  ...
  parameter is a <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> object, it will
  be used as

  the background color. If the parameter is a

  <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> object, it will be used as the
  background
  ...
  <a href="/p5.js-website/reference/p5/colorMode">colorMode()</a>. By default, colors are
  specified
