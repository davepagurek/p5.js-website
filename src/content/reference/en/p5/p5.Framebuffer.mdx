...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a> objects but can run much
  faster.
  ...
  <a href="/p5.js-website/reference/p5.Framebuffer/begin">myBuffer.begin()</a> and

  <a href="/p5.js-website/reference/p5.Framebuffer/end">myBuffer.end()</a>. The resulting
  image

  can be applied as a texture by passing the <code>p5.Framebuffer</code> object
  to the

  <a href="/p5.js-website/reference/p5/texture">texture()</a> function, as in
  <code>texture(myBuffer)</code>.

  It can also be displayed on the main canvas by passing it to the

  <a href="/p5.js-website/reference/p5/image">image()</a> function, as in
  <code>image(myBuffer, 0, 0)</code>.</p>

  <p>Note: <a href="/p5.js-website/reference/p5/createFramebuffer">createFramebuffer()</a> is
  the
...
methods:
  resize:
    description: >
      ...
      the framebuffer to 300×500 pixels, then sets <code>myBuffer.width</code>
      to 300
  ...
  createCamera:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/p5.Camera">p5.Camera</a> object to use with the
      framebuffer.</p>
      ...
      <a href="/p5.js-website/reference/p5/p5.Camera">p5.Camera</a> methods such as
      ...
      <a href="/p5.js-website/reference/p5.Framebuffer/end">myBuffer.end()</a> like so:</p>
      ...
      <p>Calling <a href="/p5.js-website/reference/p5/setCamera">setCamera()</a> updates the

      framebuffer's projection using the camera.

      <a href="/p5.js-website/reference/p5/resetMatrix">resetMatrix()</a> must also be called
      for the
  ...
  begin:
    description: >
      ...
      href="/p5.js-website/reference/p5.Framebuffer/end">myBuffer.end()</a>
      ...
      <a href="/p5.js-website/reference/p5.Framebuffer/end">myBuffer.end()</a> stops drawing
      to the
    ...
    description: >
      ...
      <p><a href="/p5.js-website/reference/p5.Framebuffer/begin">myBuffer.begin()</a> and
      <code>myBuffer.end()</code>

      allow shapes to be drawn to the framebuffer.

      <a href="/p5.js-website/reference/p5.Framebuffer/begin">myBuffer.begin()</a> begins
      drawing to
  ...
  loadPixels:
    description: >
      ...
      <a href="/p5.js-website/reference/p5.Framebuffer/pixels">pixels</a> array.</p>

      <p><code>myBuffer.loadPixels()</code> must be called before reading from
      or writing to

      <a href="/p5.js-website/reference/p5.Framebuffer/pixels">myBuffer.pixels</a>.</p>
  ...
  get:
    description: >
      ...
      <a href="/p5.js-website/reference/p5.Framebuffer/pixels">myBuffer.pixels</a>. Use

      <a href="/p5.js-website/reference/p5.Framebuffer/pixels">myBuffer.pixels</a> to read
      many pixel
      ...
      framebuffer as a a <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a>
      object.</p>
      ...
      a <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> object. The first two
      parameters are
  ...
  updatePixels:
    description: >
      ...
      in the <a href="/p5.js-website/reference/p5.Framebuffer/pixels">myBuffer.pixels</a>
      array. Such

      changes can be made directly after calling

      <a
      href="/p5.js-website/reference/p5.Framebuffer/loadPixels">myBuffer.loadPixels()</a>.</p>
...
properties:
  pixels:
    description: >
      ...
      <p><a
      href="/p5.js-website/reference/p5.Framebuffer/loadPixels">myBuffer.loadPixels()</a> must
      be

      called before accessing the <code>myBuffer.pixels</code> array.

      <a
      href="/p5.js-website/reference/p5.Framebuffer/updatePixels">myBuffer.updatePixels()</a>
      ...
      <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object instead of looping
      over
