...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> object to blend. The source
  image can be

  the canvas itself or a

  <a href="/p5.js-website/reference/p5/p5.Image">p5.Image</a> object. <code>copy()</code> will
  scale pixels from
