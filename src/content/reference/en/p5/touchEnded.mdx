...
description: >
  ...
  href="/p5.js-website/reference/p5/mouseReleased">mouseReleased()</a> will
  ...
  touch ends and <a href="/p5.js-website/reference/p5/mouseReleased">mouseReleased()</a>
  won’t.</p>

  <p>Note: <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a>,

  <code>touchEnded()</code>, and <a
  href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> are all

  related. <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a> runs as soon
  as the

  user touches a touchscreen device. <code>touchEnded()</code> runs as soon as
  the user

  ends a touch. <a href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> runs
  repeatedly as
