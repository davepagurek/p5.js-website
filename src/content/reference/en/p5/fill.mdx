...
description: >
  ...
  string. A <a href="/p5.js-website/reference/p5/p5.Color">p5.Color</a> object can also be
  provided to
  ...
  <a href="/p5.js-website/reference/p5/colorMode">colorMode()</a>. The default color space is
  RGB,
