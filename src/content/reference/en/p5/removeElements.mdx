...
file: src/dom/dom.js
description: >
  <p>Removes all elements created by p5.js, including any event handlers.</p>

  <p>There are two exceptions:

  canvas elements created by <a
  href="/p5.js-website/reference/p5/createCanvas">createCanvas()</a>

  and <a href="/p5.js-website/reference/p5/p5.Renderer">p5.Render</a> objects created by
