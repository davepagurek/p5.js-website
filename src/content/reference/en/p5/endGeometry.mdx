...
description: >
  ...
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> object and returns the
  object.</p>
  ...
  <a href="/p5.js-website/reference/p5/sphere">sphere()</a>. <code>beginGeometry()</code>
  begins adding shapes

  to a custom <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> object and

  <a href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> stops adding them.</p>

  <p><code>beginGeometry()</code> and <a
  href="/p5.js-website/reference/p5/endGeometry">endGeometry()</a> can help
  ...
  Creating a <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a> object once and
  then

  drawing it will run faster than repeatedly drawing the individual pieces.</p>

  <p>See <a href="/p5.js-website/reference/p5/buildGeometry">buildGeometry()</a> for another
  way to
