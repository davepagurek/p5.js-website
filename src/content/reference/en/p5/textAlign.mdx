...
description: >
  <p>Sets the way text is aligned when <a href="/p5.js-website/reference/p5/text">text()</a>
  is called.</p>
  ...
  <a href="/p5.js-website/reference/p5/text">text()</a> interprets x-coordinates. By default,
  the
  ...
  <a href="/p5.js-website/reference/p5/text">text()</a> interprets y-coordinates. By default,
  the
