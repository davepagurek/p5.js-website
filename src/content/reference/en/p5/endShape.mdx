...
description: >
  ...
  <p>The <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> and
  <code>endShape()</code> functions

  allow for creating custom shapes in 2D or 3D.

  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> begins adding vertices to
  a
  ...
  <p>After calling <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a>, shapes
  can be

  built by calling <a href="/p5.js-website/reference/p5/vertex">vertex()</a>,
  ...
  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> and
  <code>endShape()</code>. It's also not

  possible to use other shapes, such as <a
  href="/p5.js-website/reference/p5/ellipse">ellipse()</a> or

  <a href="/p5.js-website/reference/p5/rect">rect()</a>, between
