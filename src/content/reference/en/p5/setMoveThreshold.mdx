...
description: >
  <p>The <a href="/p5.js-website/reference/p5/setMoveThreshold">setMoveThreshold()</a>
  function is used to set the movement threshold for

  the <a href="/p5.js-website/reference/p5/deviceMoved">deviceMoved()</a> function. The
