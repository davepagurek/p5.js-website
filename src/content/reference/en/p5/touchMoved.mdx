...
description: >
  ...
  href="/p5.js-website/reference/p5/mouseDragged">mouseDragged()</a> will
  ...
  touch points move and <a href="/p5.js-website/reference/p5/mouseDragged">mouseDragged()</a>
  won’t.</p>

  <p>Note: <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a>,

  <a href="/p5.js-website/reference/p5/touchEnded">touchEnded()</a>, and

  <code>touchMoved()</code> are all related.

  <a href="/p5.js-website/reference/p5/touchStarted">touchStarted()</a> runs as soon as the
  user
