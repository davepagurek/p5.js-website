...
description: >
  ...
  <a href="/p5.js-website/reference/p5/createCanvas">createCanvas()</a> or

  <a href="/p5.js-website/reference/p5/resizeCanvas">resizeCanvas()</a> changes the value of

  <code>height</code>. Calling <a href="/p5.js-website/reference/p5/noCanvas">noCanvas()</a>
  sets its value to
