...
description: >
  ...
  created, it can be used with the <a href="/p5.js-website/reference/p5/shader">shader()</a>
  ...
  <p>Note: <a href="/p5.js-website/reference/p5/createShader">createShader()</a>,

  <a href="/p5.js-website/reference/p5/createFilterShader">createFilterShader()</a>, and

  <a href="/p5.js-website/reference/p5/loadShader">loadShader()</a> are the recommended ways
  to
...
methods:
  ...
  modify:
    description: >
      ...
      can also add a <code>declarations</code> key, where the value is a GLSL
      string declaring

      <a href="/p5.js-website/reference/p5.Shader/setUniform">uniform variables</a> and
      globals shared

      between hooks. To add declarations jsut in a vertex or fragment shader,
      add
  ...
  copyToContext:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/shader">shader()</a> before it can run. Compilation
      happens

      in a drawing context which is usually the main canvas or an instance of

      <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a>. A shader can only be
      used in the
      ...
      <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a>, as in

      <code>myShader.copyToContext(pg)</code>. The shader can also be copied
      from a

      <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a> object to the main
      canvas using

      the <code>window</code> variable, as in
      <code>myShader.copyToContext(window)</code>.</p>

      <p>Note: A <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> object created
      with

      <a href="/p5.js-website/reference/p5/createShader">createShader()</a>,

      <a href="/p5.js-website/reference/p5/createFilterShader">createFilterShader()</a>, or

      <a href="/p5.js-website/reference/p5/loadShader">loadShader()</a>

      can be used directly with a <a
      href="/p5.js-website/reference/p5/p5.Framebuffer">p5.Framebuffer</a>

      object created with

      <a href="/p5.js-website/reference/p5/createFramebuffer">createFramebuffer()</a>. Both
      objects
