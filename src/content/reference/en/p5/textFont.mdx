...
description: >
  <p>Sets the font used by the <a href="/p5.js-website/reference/p5/text">text()</a>
  function.</p>

  <p>The first parameter, <code>font</code>, sets the font.
  <code>textFont()</code> recognizes either

  a <a href="/p5.js-website/reference/p5/p5.Font">p5.Font</a> object or a string with the name
  of a
