...
description: >
  ...
  <a href="/p5.js-website/reference/p5/saturation">saturation()</a> is called.</p>
  ...
  <p>Note: <a href="/p5.js-website/reference/p5/color">color()</a> is the recommended way to
  create an
...
methods:
  ...
  setRed:
    description: >
      ...
      href="/p5.js-website/reference/p5/colorMode">colorMode()</a>. In the
  ...
  setAlpha:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/colorMode">colorMode()</a>. In the default RGB mode
      it's
