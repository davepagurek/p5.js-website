...
description: >
  ...
  href="/p5.js-website/reference/p5/mouseX">mouseX</a> and

  <a href="/p5.js-website/reference/p5/mouseY">mouseY</a>, will be updated with their most
  recent
  ...
  ends if <a href="/p5.js-website/reference/p5/touchEnded">touchEnded()</a> isn’t declared. If

  <a href="/p5.js-website/reference/p5/touchEnded">touchEnded()</a> is declared, then

  <a href="/p5.js-website/reference/p5/touchEnded">touchEnded()</a> will run when a user’s
  touch
  ...
  <p>Note: <a href="/p5.js-website/reference/p5/mousePressed">mousePressed()</a>,

  <a href="/p5.js-website/reference/p5/mouseReleased">mouseReleased()</a>,

  and <code>mouseClicked()</code> are all related.

  <a href="/p5.js-website/reference/p5/mousePressed">mousePressed()</a> runs as soon as the
  user

  clicks the mouse. <a href="/p5.js-website/reference/p5/mouseReleased">mouseReleased()</a>
  runs as
