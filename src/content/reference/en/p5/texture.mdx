...
description: >
  ...
  built-in shapes, such as <a href="/p5.js-website/reference/p5/square">square()</a> and

  <a href="/p5.js-website/reference/p5/sphere">sphere()</a>, and custom shapes created with

  functions such as <a href="/p5.js-website/reference/p5/buildGeometry">buildGeometry()</a>.
  To

  texture a geometry created with <a
  href="/p5.js-website/reference/p5/beginShape">beginShape()</a>,

  uv coordinates must be passed to each

  <a href="/p5.js-website/reference/p5/vertex">vertex()</a> call.</p>
  ...
  <a href="/p5.js-website/reference/p5/p5.Graphics">p5.Graphics</a> and

  <a href="/p5.js-website/reference/p5/p5.Framebuffer">p5.Framebuffer</a> objects.</p>

  <p>To texture a geometry created with <a
  href="/p5.js-website/reference/p5/beginShape">beginShape()</a>,

  you will need to specify uv coordinates in <a
  href="/p5.js-website/reference/p5/vertex">vertex()</a>.</p>
