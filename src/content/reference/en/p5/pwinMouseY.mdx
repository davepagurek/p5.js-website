...
description: >
  ...
  <a href="/p5.js-website/reference/p5/winMouseY">winMouseY</a> from the previous frame. For
  ...
  <a href="/p5.js-website/reference/p5/winMouseY">winMouseY</a> value at the start of each
  touch

  event.</p>

  <p>Note: Use <a href="/p5.js-website/reference/p5/pmouseY">pmouseY</a> to track the mouse’s
  previous
