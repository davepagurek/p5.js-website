...
methods:
  ...
  clearColors:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/fill">fill()</a> has no effect. Calling

      <code>myGeometry.clearColors()</code> allows the

      <a href="/p5.js-website/reference/p5/fill">fill()</a> function to apply color to the
      geometry.</p>
  ...
  flipU:
    description: >
      ...
      <p>In order for <a href="/p5.js-website/reference/p5/texture">texture()</a> to work, the
      geometry
      ...
      <p>The <a href="/p5.js-website/reference/p5.Geometry/uvs">myGeometry.uvs</a> array
      stores the
  ...
  computeFaces:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a>

      objects in the <a
      href="/p5.js-website/reference/p5.Geometry/vertices">myGeometry.vertices</a>

      array. The geometry's first vertex is the

      <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object at
      ...
      <a href="/p5.js-website/reference/p5.Geometry/faces">myGeometry.faces</a> array with
      three-element
      ...
      two triangles. <a href="/p5.js-website/reference/p5.Geometry/faces">myGeometry.faces</a>
      for a
  ...
  computeNormals:
    description: >
      ...
      are stored as <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> objects in
      the

      <a
      href="/p5.js-website/reference/p5.Geometry/vertexNormals">myGeometry.vertexNormals</a>
      array.</p>
  ...
  normalize:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/setup">setup()</a> function.</p>
...
properties:
  vertices:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> objects in the
  ...
  faces:
    description: >
      ...
      <a href="/p5.js-website/reference/p5.Geometry/vertices">myGeometry.vertices</a> array.
      The
