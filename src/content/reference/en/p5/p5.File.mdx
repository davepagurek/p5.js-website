...
description: |
  ...
  <a href="/p5.js-website/reference/p5.Element/drop">myElement.drop()</a> and
  created by
  <a href="/p5.js-website/reference/p5/createFileInput">createFileInput</a>.</p>
line: 5464
isConstructor: true
params:
  - name: file
...
properties:
  ...
  data:
    description: |
      ...
      case of JSON and <a href="/p5.js-website/reference/p5/p5.XML">p5.XML</a> objects.</p>
    path: p5.File/data
chainable: false
---
