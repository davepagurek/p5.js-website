...
description: >
  ...
  point if <a href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> isn’t declared.
  If

  <a href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> is declared, then

  <a href="/p5.js-website/reference/p5/touchMoved">touchMoved()</a> will run when a user moves
  a
