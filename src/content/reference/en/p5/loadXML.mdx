...
description: >
  <p>Loads an XML file to create a <a href="/p5.js-website/reference/p5/p5.XML">p5.XML</a>
  object.</p>
  ...
  <a href="/p5.js-website/reference/p5/p5.XML">p5.XML</a> object created from the data will be
  passed
  ...
  <a href="/p5.js-website/reference/p5/preload">preload()</a> ensures data loads before it's
  used in

  <a href="/p5.js-website/reference/p5/setup">setup()</a> or <a
