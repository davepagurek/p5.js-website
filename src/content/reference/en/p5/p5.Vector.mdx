...
description: >
  ...
  <p>Note: <a href="/p5.js-website/reference/p5/createVector">createVector()</a> is the
  recommended way
...
methods:
  ...
  set:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object, as in
  ...
  copy:
    description: >
      <p>Returns a copy of the <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a>
      object.</p>
    path: p5.Vector/copy
  add:
    description: >
      ...
      another <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object, as in
      ...
      <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object and doesn't change
      the
  ...
  rem:
    description: >
      ...
      new <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object and doesn't
      change the
  ...
  sub:
    description: >
      ...
      example, <code>v.sub(4, 5)</code> subtracts 4 from <code>v.x</code>, 5
      from <code>v.y</code>, and 0 from <code>v.z</code>.
  ...
  mag:
    description: >
      ...
      <p>Use <a href="/p5.js-website/reference/p5/mag">mag()</a> to calculate the magnitude of
      a 2D vector
  ...
  dot:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object.</p>
  ...
  dist:
    description: >
      ...
      <p>Use <a href="/p5.js-website/reference/p5/dist">dist()</a> to calculate the distance
      between points
  ...
  normalize:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object so
      ...
      returns a new <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object and
      doesn't change
  ...
  setMag:
    description: >
      ...
      a new <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object and doesn't
      change the
  ...
  heading:
    description: >
      ...
      href="/p5.js-website/reference/p5/angleMode">angleMode()</a>.</p>
  ...
  angleBetween:
    description: >
      ...
      <a href="/p5.js-website/reference/p5/angleMode">angleMode()</a>.</p>
  ...
  slerp:
    description: >
      ...
      href="/p5.js-website/reference/p5.Vector/lerp">lerp()</a> because
  ...
  equals:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> objects.</p>
  ...
  clampToZero:
    description: >
      ...
      href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> that are very close to zero
      with zero.</p>
