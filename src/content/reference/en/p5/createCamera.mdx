...
description: >
  <p>Creates a new <a href="/p5.js-website/reference/p5/p5.Camera">p5.Camera</a> object and
  sets it
  ...
  <a href="/p5.js-website/reference/p5/camera">camera()</a>,

  <a href="/p5.js-website/reference/p5/perspective">perspective()</a>,

  <a href="/p5.js-website/reference/p5/ortho">ortho()</a>, and

  <a href="/p5.js-website/reference/p5/frustum">frustum()</a> if it's the only camera in the
  scene.</p>
