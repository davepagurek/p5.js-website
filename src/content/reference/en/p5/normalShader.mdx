...
description: >
  ...
  href="/p5.js-website/reference/p5/normalMaterial"><code>normalMaterial()</code></a>.</p>

  <p>You can call <a
  href="/p5.js-website/reference/p5.Shader/modify"><code>normalShader().modify()</code></a>
  ...
  <p>Call <code>normalShader().inspectHooks()</code> to see all the possible
  hooks and
