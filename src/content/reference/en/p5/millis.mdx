...
description: >
  ...
  <a href="/p5.js-website/reference/p5/setup">setup()</a> function, then <code>millis()</code>
  begins tracking

  time before the code in <a href="/p5.js-website/reference/p5/setup">setup()</a> runs. If a

  sketch includes a <a href="/p5.js-website/reference/p5/preload">preload()</a> function, then

  <code>millis()</code> begins tracking time as soon as the code in

  <a href="/p5.js-website/reference/p5/preload">preload()</a> starts running.</p>
line: 112
isConstructor: false
itemtype: method
example:
