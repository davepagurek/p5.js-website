...
description: >
  ...
  <a href="/p5.js-website/reference/p5/draw">draw()</a> begins looping. If the

  <a href="/p5.js-website/reference/p5/preload">preload()</a> is declared, then
  <code>setup()</code> will

  run immediately after <a href="/p5.js-website/reference/p5/preload">preload()</a> finishes
