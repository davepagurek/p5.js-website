...
description: >
  <p>Stops the code in <a href="/p5.js-website/reference/p5/draw">draw()</a> from running
  repeatedly.</p>

  <p>By default, <a href="/p5.js-website/reference/p5/draw">draw()</a> tries to run 60 times
  per

  second. Calling <code>noLoop()</code> stops <a
  href="/p5.js-website/reference/p5/draw">draw()</a> from

  repeating. The draw loop can be restarted by calling

  <a href="/p5.js-website/reference/p5/loop">loop()</a>. <a
  href="/p5.js-website/reference/p5/draw">draw()</a> can be run

  once by calling <a href="/p5.js-website/reference/p5/redraw">redraw()</a>.</p>

  <p>The <a href="/p5.js-website/reference/p5/isLooping">isLooping()</a> function can be used
  to check
