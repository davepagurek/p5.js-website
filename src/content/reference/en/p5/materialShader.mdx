...
description: >
  ...
  <p>You can call <a
  href="/p5.js-website/reference/p5.Shader/modify"><code>materialShader().modify()</code></a>
  ...
  <p>Call <code>materialShader().inspectHooks()</code> to see all the possible
  hooks and
...
example:
  ...
  - |-
    ...
    function preload() {
      environment = loadImage('/p5.js-website/assets/outdoor_spheremap.jpg');
    }
