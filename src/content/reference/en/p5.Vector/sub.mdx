...
description: >
  ...
  example, <code>v.sub(4, 5)</code> subtracts 4 from <code>v.x</code>, 5 from
  <code>v.y</code>, and 0 from <code>v.z</code>.
  ...
  <a href="/p5.js-website/reference/p5/p5.Vector">p5.Vector</a> object and doesn't change the
