...
description: |-
  ...
  <p>Algunas pantallas utilizan varios píxeles más pequeños para establecer el color en un solo punto. La función <a href="/p5.js-website/reference/p5/pixelDensity">pixelDensity()</a> devuelve la densidad de píxeles del lienzo. Las pantallas de alta densidad a menudo tienen una <a href="/p5.js-website/reference/p5/pixelDensity">pixelDensity()</a> de 2. En una pantalla así, el array <code>pixels</code> para un lienzo de 100×100 tiene 200 × 200 × 4 = 160.000 elementos.</p>

  <p>Acceder a los valores de RGBA para un punto en el lienzo requiere un poco de matemáticas como se muestra a continuación. La función <a href="/p5.js-website/reference/p5/loadPixels">loadPixels()</a> debe ser llamada antes de acceder al array <code>pixels</code>. La función <a href="/p5.js-website/reference/p5/updatePixels">updatePixels()</a> debe ser llamada después de realizar cualquier cambio.</p>
line: '12'
isConstructor: 'false'
itemtype: property
example:
