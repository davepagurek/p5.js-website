...
description: >
  ...
  <a href="/p5.js-website/reference/p5/noSmooth">noSmooth()</a> es útil para escalar imágenes

  sin borrosidad. Las funciones no afectan formas ni fuentes.</p>

  <p>En el modo WebGL, <a href="/p5.js-website/reference/p5/noSmooth">noSmooth()</a> hace que todas las formas se
