...
description: >
  ...
  <a href="/p5.js-website/reference/p5/endClip">endClip()</a> se agregará a la figura de enmascaramiento (máscara).

  La máscara se aplicará a todo lo dibujado después de

  <a href="/p5.js-website/reference/p5/endClip">endClip()</a>.</p>
  ...
  <a href="/p5.js-website/reference/p5/push">push()</a> y <a href="/p5.js-website/reference/p5/pop">pop()</a>.
