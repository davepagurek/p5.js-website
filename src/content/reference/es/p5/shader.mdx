...
description: >
  <p>Establece el objeto <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> para aplicar mientras se dibuja.</p>
  ...
  <p>Los objetos <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> se pueden crear utilizando las funciones <a href="/p5.js-website/reference/p5/createShader">createShader()</a> y <a href="/p5.js-website/reference/p5/loadShader">loadShader()</a>.</p>

  <p>El parámetro <code>s</code> es el objeto <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> que se va a aplicar. Por ejemplo, llamar a <code>shader(myShader)</code> aplica <code>myShader</code> para procesar cada píxel en el lienzo. El shader se utilizará para:</p>
  ...
  <p>El código fuente de los shaders de fragmentos y vértices de un objeto <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> se compilará la primera vez que se pase a <code>shader()</code>. Consulta <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/compileShader" target="_blank">MDN</a> para obtener más información sobre la compilación de shaders.</p>

  <p>Llamar a <a href="/p5.js-website/reference/p5/resetShader">resetShader()</a> restaura los shaders predeterminados del sketch.</p>
