...
description: >
  ...
  función <a href="/p5.js-website/reference/p5/bezier">bezier()</a>.
  <code>bezierVertex()</code> debe ser

  llamada entre las funciones

  <a href="/p5.js-website/reference/p5/beginShape">beginShape()</a> y

  <a href="/p5.js-website/reference/p5/endShape">endShape()</a>. El segmento curvo utiliza

  el vértice anterior como el primer punto de anclaje, por lo que debe haber al menos

  una llamada a <a href="/p5.js-website/reference/p5/vertex">vertex()</a> antes de que
