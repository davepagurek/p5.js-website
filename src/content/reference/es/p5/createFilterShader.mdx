...
description: >
  <p>Crea un objeto <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> para ser utilizado
  con la función <a href="/p5.js-website/reference/p5/filter">filter()</a>.</p>

  <p><code>createFilterShader()</code> funciona de manera similar a
  <a href="/p5.js-website/reference/p5/createShader">createShader()</a> pero incluye un
  vertex shader predeterminado. <code>createFilterShader()</code> está diseñado
  para ser utilizado junto con <a href="/p5.js-website/reference/p5/filter">filter()</a> para
  filtrar el contenido de un lienzo.</p>

  <p>Un filtro shader se aplicará a todo el lienzo en lugar de solo a los objetos
  <a href="/p5.js-website/reference/p5/p5.Geometry">p5.Geometry</a>.</p>
  ...
  <p>El objeto <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> que se crea tiene
  ...
  <p>El <a href="/p5.js-website/reference/p5/p5.Shader">p5.Shader</a> que se crea también
