...
file: src/dom/dom.js
description: >
  <p>Elimina todos los elementos creados por p5.js, incluidos los manejadores de eventos.</p>

  <p>Hay dos excepciones:

  los elementos canvas creados por <a
  href="/p5.js-website/reference/p5/createCanvas">createCanvas()</a>

  y los objetos <a href="/p5.js-website/reference/p5/p5.Renderer">p5.Render</a> creados por

  <a href="/p5.js-website/reference/p5/createGraphics">createGraphics()</a>.</p>
line: 255
isConstructor: false
itemtype: method
example:
